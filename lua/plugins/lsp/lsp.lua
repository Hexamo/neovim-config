return {
    ...
    config = function()
        ...
        local on_attach = function(client, bufnr)
            ...
            keymap.set("n", "<leader>lv", vim.lsp.buf.code_action, opts)  -- see available code actions, in visual mode will apply to selection
        ...
        -- configure Marksman language server (replace "marksman-lsp" with the correct command if this is incorrect)
